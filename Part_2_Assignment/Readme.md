To make this a "one-of-a-kind" README, we will structure it as a **Traceability Matrix**. This bridges the gap between the professor's strict requirements and your technical implementation, proving that every mark has been earned.

Here is the 11/10 README.md for your repository:

---

#  Project: Autonomous Drone Rescue
